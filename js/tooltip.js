...
function Tooltip(opts, data) {
 ...
 addTip: function() {
  ...
  // So keep it out of the listeners array.
   g.addListener(me.data_, "dragend", function() {
     me.dataDragging = false; });
     
  // Register listeners
  me.listeners = [
//   g.addListener(me.data_, "dragend", function() {
//    me.dataDragging = false; }),	
   g.addListener(me.data_, "position_changed", function() {
    me.dataDragging = true;
    me.set("visible", false); }),
